...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/postgres/postgres/1.0.1.0/postgres-1.0.1.0.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.postgres:postgres:1.0.1.0'
}
```