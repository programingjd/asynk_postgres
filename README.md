![jcenter](https://img.shields.io/badge/_jcenter_-0.0.0.32-6688ff.png?style=flat) &#x2003; ![jcenter](https://img.shields.io/badge/_Tests_-118/118-green.png?style=flat)
# Asynk POSTGRES
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/asynk/postgres/0.0.0.32/postgres-0.0.0.32.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.asynk:postgres:0.0.0.32'
}
```
